...
namespace AccessData.Configuration
{
    public class ClienteConfiguration
    {
        public ClienteConfiguration(EntityTypeBuilder<Cliente> entityBuilder)
        {
            ...
            cliente.Add(new Cliente { ClienteId = 98, Nombre = "Claudio", Apellido = "Damico", Email = "claudio.damico@gmail.com", Dni = "12383764", Direccion = "Moreno 322", Telefono = "1123455877" });
            cliente.Add(new Cliente { ClienteId = 99, Nombre = "Julian", Apellido = "Nuzzo", Email = "julian.nuzzo@gmail.com", Dni = "39987666", Direccion = "Lavelle 987", Telefono = "1123982376" });
